...
.grace-full-loading view{width:150rpx; height:150rpx; background:#eee; position:absolute; z-index:100;  left:50%; top:50%; transform: translate(-50%, -50%); border-radius:100%; animation:grace-fade 3500ms infinite linear; opacity:0.6; padding:10rpx;}
