			...
			selectImage: function(){
				...
				uni.chooseImage({
					...
					success: function(e){
						...
						var token=uni.getStorageSync("tokenInfo");
						...
						if(_self.serverUrl){
							...
							Promise.all(promiseWorkList).then((result)=>{
								...
								console.log("upload image arr:",result)
								for(let i=0; i<result.length;i++){
									
									var o=JSON.parse(result[i]);
									console.log("upload image:",o)
									_self.imageList.push(o.path)
								}
